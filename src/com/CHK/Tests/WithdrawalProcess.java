...
public class WithdrawalProcess {
	...
	wallet.clickOnwWithdrawalBtn();
	
	Thread.sleep(3000);
	
	wallet.enterBVN();
	wallet.clickOnSubmitBtn();
	
	Thread.sleep(3000);
	
	String error_message = wallet.errorMessage();
	Assert.assertEquals(error_message.contains(" Please check your BVN and try again "), true);
